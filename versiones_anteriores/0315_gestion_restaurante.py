...
""" 
    * Cambiar nombres de funciones a ingles/español-            OK!!
    * Definir returns de error (nomenclatura) y documentar      OK!!
    * Actualizar las imagenes de las funciones                  OK!!
    * Completar descripciones de funciones en documento         OK!!
    * Escribir mejoras a añadir en futuras versiones para el nivel intermedio ??? v2
    * Definir seccion de strings para mensajes repetidos ??? v2
    * Añadir las bibliotecas utilizadas en el proyecto a la documentacion ??? OK!!
    * Añadir prints de 'DEBUG' o 'CONTROL' por consola ??? OK!!
