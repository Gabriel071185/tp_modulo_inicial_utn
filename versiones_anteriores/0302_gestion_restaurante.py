...
def reset_menu():
    ...
    global suma
    suma = 0
    pantalla_registro.config(text="Borrón y cuenta nueva!")
...
pantalla_registro = tk.Label(panel_menu1, text="Bienvenido", font=("Arial", 15), bg=c_hueso, fg=c_marron_osc, bd=3, relief="raised")
